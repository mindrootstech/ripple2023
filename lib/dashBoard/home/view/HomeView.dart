       ...
       SizedBox(
         ...
         child: Column(
           ...
           children: [
             ...
             Container(
               margin: EdgeInsets.only(left: CommonUi.marginLeftRight, right: CommonUi.marginLeftRight, top: 24),
               height: 50,
               width: Get.width,
             ...
             Container(
               ...
               child: Text(Strings.textCategories, style: CommonUi.customTextStyle(fontFamily: Fonts.semiBold,
               fontSize: 18),),
             ),
             ...
             Container(
               margin: EdgeInsets.only(left: CommonUi.marginLeftRight),
               child: Text(Strings.textActions, style: CommonUi.customTextStyle(fontFamily: Fonts.semiBold, fontSize: 18),),
             ),
             const SizedBox(height: 16),
             getActionsList(),
